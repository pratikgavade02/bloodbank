...
<header class="continer-fluid ">
        ...
        <!--search blood - -->
        <div class="container" style="max-width: 600px; padding: 50px;box-shadow: rgba(100,100, 111, 0.2) 0px 7px 29px 0px; margin-top:80px">
<h2>Search Blood</h2>
<form action="searchblood.jsp" method="post">
<input type="text" placeholder="Enter Blood Group" name="bname" class="form-control" style="margin-top:20px;" id="nm"><br>
